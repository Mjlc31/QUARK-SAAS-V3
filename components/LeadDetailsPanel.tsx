                                    ...
                                    {!aiProposal ? (
                                        <div className="text-center py-6 relative z-10">
                                            ...
                                            <button onClick={onGenerateAI} disabled={isGeneratingAI}
                                                className="w-full py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-sm text-lime-400 font-bold transition-all flex justify-center items-center gap-2">
                                        ...
                                        <div className="relative z-10 animate-enter">
                                            ...
                                            <div className="flex gap-3 mt-4">
                                                <button onClick={onClearAI} className="px-4 py-2 text-xs font-semibold text-zinc-400 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10 rounded-xl transition-all">Descartar</button>
                    ...
                    {activeTab === 'empresa' && (
                        <div className="space-y-6">
                            ...
                            <button onClick={onSave}
                                className="w-full py-3 bg-lime-500/10 hover:bg-lime-500/20 border border-lime-500/30 text-lime-400 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2">
