        ...
        <div className="space-y-6">
            ...
            <div className="pt-4">
                <button 
                    ...
                    className="w-full py-4 bg-lime-500 hover:bg-lime-400 text-black rounded-xl font-bold text-sm transition-all flex justify-center items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed min-w-[44px] min-h-[44px]">
