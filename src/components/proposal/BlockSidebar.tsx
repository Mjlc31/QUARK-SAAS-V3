      ...
      <div className="px-4 py-4">
        ...
        <div className="flex flex-col gap-2">
          <button onClick={handleSaveTemplate}
            className="w-full py-2.5 rounded-xl border border-amber-400/25 bg-amber-400/6 text-amber-400 text-[12px] font-bold hover:bg-amber-400/12 transition-all min-w-[44px] min-h-[44px] flex items-center justify-center">
            💾 Salvar como Padrão
          </button>
          <button onClick={handleLoadTemplate}
            className="w-full py-2.5 rounded-xl border border-white/8 bg-white/[0.02] text-white/40 text-[12px] font-semibold hover:text-white/70 hover:border-white/15 transition-all min-w-[44px] min-h-[44px] flex items-center justify-center">
