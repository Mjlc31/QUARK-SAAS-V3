    ...
    >
      ...
      <div className={`absolute -left-9 top-4 flex flex-col gap-1.5 z-20 transition-all duration-150 ${
        ...
        <button
          ...
          {...listeners}
          title="Arrastar"
          className="w-7 h-7 rounded-lg border border-white/10 bg-[#0b0f1a] flex items-center justify-center text-white/30 hover:text-amber-400 hover:border-amber-400/30 cursor-grab active:cursor-grabbing transition-all shadow-xl min-w-[44px] min-h-[44px]"
