    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3.5">
          <button
            onClick={onClose}
            className="w-7 h-7 rounded-lg flex items-center justify-center text-white/30 hover:text-white hover:bg-white/8 transition-all min-w-[44px] min-h-[44px]"
            title="Fechar Editor"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleExportLight} disabled={isExportingLight}
            className="flex items-center gap-1.5 px-3 py-1.5 text-[12px] font-bold rounded-lg transition-all disabled:opacity-60 border hover:brightness-110 active:scale-95 min-w-[44px] min-h-[44px]"
            style={{
          ...
          <button onClick={handleExport} disabled={isExporting}
            className="flex items-center gap-1.5 px-4 py-1.5 text-[12px] font-bold rounded-lg transition-all disabled:opacity-60 hover:brightness-110 active:scale-95 min-w-[44px] min-h-[44px]"
            style={{
