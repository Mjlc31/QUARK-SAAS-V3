                ...
                <div className="w-full lg:w-2/3 flex flex-col bg-[#0d1117] border border-white/5 rounded-2xl overflow-hidden shadow-2xl animate-enter">
                    ...
                    <div className="p-6 border-b border-white/5 bg-black/20 flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            <button onClick={handleDelete} className="flex items-center gap-2 px-3 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 rounded-xl text-sm font-bold transition-all min-w-[44px] min-h-[44px]" title="Excluir Projeto">
                                <Trash2 size={16} /> <span className="hidden sm:inline">Excluir</span>
                            </button>
                            <button onClick={handleSave} disabled={saving} className="flex items-center gap-2 px-4 py-2 bg-lime-500 hover:bg-lime-400 text-black rounded-xl text-sm font-bold transition-all disabled:opacity-50 min-w-[44px] min-h-[44px]">
