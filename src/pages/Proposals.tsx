                  ...
                  {step === 1 && (
                      <div className="space-y-4 relative z-10 animate-enter">
                          ...
                          <div className="flex gap-4 pt-2">
                              ...
                              <button onClick={handleNextStep1} className="flex-1 py-4 bg-lime-500 text-black font-bold rounded-xl shadow-[0_0_20px_rgba(163,230,53,0.2)] hover:bg-lime-400 flex items-center justify-center gap-2 transition-all min-w-[44px] min-h-[44px]">
                  ...
                  {step === 2 && (
                      <div className="space-y-6 relative z-10 animate-enter">
                          ...
                          <div className="flex gap-4 mt-8">
                              ...
                              <button onClick={handleNextStep2} className="flex-1 py-4 bg-lime-500 text-black font-bold rounded-xl shadow-[0_0_20px_rgba(163,230,53,0.2)] hover:bg-lime-400 flex items-center justify-center gap-2 transition-all min-w-[44px] min-h-[44px]">
                  ...
                  {step === 3 && (
                      <div className="space-y-6 relative z-10 animate-enter">
                          ...
                          <div className="flex gap-4 pt-4 border-t border-white/5 mt-6">
                              ...
                              <button onClick={handleCalculatePrice} className="w-2/3 py-4 bg-lime-500 text-black font-bold rounded-xl shadow-[0_0_25px_rgba(163,230,53,0.3)] hover:bg-lime-400 flex items-center justify-center gap-2 transition-all active:scale-95 text-lg min-w-[44px] min-h-[44px]">
                                  Gerar Documento (PDF)
                              </button>
                          </div>
                      </div>
