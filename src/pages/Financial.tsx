...
import {
    ...
    ArrowUpRight, Calendar, Filter, X, AlertTriangle,
    Activity, Target, Loader2, Check
} from 'lucide-react';
import {
        ...
        <div className="min-h-[100dvh] pb-16">
            ...
            <div className="flex flex-col gap-4 mb-8">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <button onClick={generatePDFReport} className="flex items-center gap-2 px-4 py-2 bg-zinc-900 border border-white/10 text-slate-300 rounded-xl text-sm hover:border-white/20 transition-colors min-w-[44px] min-h-[44px]">
                    ...
                    <div className="bg-[#0b0f15] border-l border-white/10 w-full max-w-md h-full shadow-2xl flex flex-col animate-slide-in-right relative">
                        ...
                        <div className="p-6 border-t border-white/5 bg-black/40 relative z-10 flex gap-3">
                            ...
                            <button onClick={handleAdd} disabled={!form.description || !form.amount || saving}
                                className="flex-1 py-3.5 bg-gradient-to-r from-lime-500 to-lime-400 hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed text-black shadow-[0_0_15px_rgba(132,204,34,0.3)] rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-2 min-w-[44px] min-h-[44px]">
