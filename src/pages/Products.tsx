...
import { Package, Plus, Trash2, Zap, Search, Layers, Box, Cpu, Cable, CircuitBoard, Hammer, X, ChevronDown, Check, DollarSign } from 'lucide-react';
            ...
            return (
              <div key={product.id} className="glass-panel p-0 rounded-2xl group hover:border-lime-500/30 transition-all flex flex-col h-full overflow-hidden relative">
                ...
                <div className="p-6 mt-auto flex items-end justify-between">
                   ...
                   <button className="p-2 bg-white/5 hover:bg-white/10 rounded-lg text-slate-400 hover:text-white transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center">
                     <Plus size={18} />
                   </button>
                </div>
              </div>
          ...
          <div className="glass-panel w-full max-w-2xl rounded-3xl border border-white/20 shadow-2xl animate-enter flex flex-col max-h-[90vh]">
            ...
            <div className="p-8 border-t border-white/10 flex gap-4 bg-zinc-900/50 rounded-b-3xl">
              ...
              <button 
                ...
                className="flex-1 py-4 rounded-xl bg-lime-500 hover:bg-lime-400 text-black font-bold shadow-lg shadow-lime-500/20 transition-all active:scale-95 flex items-center justify-center gap-2 min-w-[44px] min-h-[44px]"
              >
