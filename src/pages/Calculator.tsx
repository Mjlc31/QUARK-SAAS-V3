...
import { Calculator as CalcIcon, Sun, Zap, FileText, MapPin, AlertTriangle, TrendingUp, Leaf, Trees, DollarSign, Settings2, Package, Check, UserPlus, ArrowRight, PiggyBank, Loader2 } from 'lucide-react';
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="pt-2 flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl bg-[#0B0A10] border border-lime-500/30 text-lime-400 font-black text-sm transition-all flex justify-center items-center gap-2 hover:bg-lime-500/10 hover:shadow-[0_0_20px_rgba(132,204,34,0.15)] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed min-w-[44px] min-h-[44px]"
              >
          ...
          <div className="bg-[#0d1117] border border-white/10 rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 border-t border-white/5 flex gap-3">
              ...
              <button onClick={generatePDF} disabled={isGeneratingPDF}
                className="flex-1 py-3 bg-lime-500 hover:bg-lime-400 disabled:opacity-50 disabled:cursor-not-allowed text-black rounded-xl text-sm font-bold transition-colors flex items-center justify-center gap-2 min-w-[44px] min-h-[44px]">
