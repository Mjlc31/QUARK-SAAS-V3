...
import { Plus, Search, MapPin, HardHat, Send, CheckCircle2, Clock, X, Trash2, User as UserIcon, Phone } from 'lucide-react';
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-4 flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 btn-primary py-3 rounded-xl font-bold shadow-lg disabled:opacity-50 disabled:cursor-not-allowed min-w-[44px] min-h-[44px]"
                                >
                                    Criar Projeto
                                </button>
                            </div>
