...
import { HardHat, Link as WebhookIcon, Paperclip, Plus, Loader2, Calendar, FileText, X, Tag, Clock, CheckSquare, AlignLeft, User, MapPin, Map, Home, Image as ImageIcon, MessageSquare, MoreHorizontal } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 h-[calc(100vh-10rem)] md:h-[calc(100vh-6rem)] lg:h-[calc(100vh-2rem)] flex flex-col relative animate-enter">
      <div className="flex justify-between items-center shrink-0">
        ...
        <button onClick={handleAddObra} className="flex items-center gap-2 px-5 py-2.5 bg-lime-500 text-black font-bold rounded-xl hover:bg-lime-400 transition-colors shadow-[0_0_20px_rgba(163,230,53,0.2)] active:scale-95 min-w-[44px] min-h-[44px]">
            ...
            {selectedObra.attachments && selectedObra.attachments.length > 0 && isImageFile(selectedObra.attachments[0]) && (
              <div className="h-48 w-full bg-black relative shrink-0 border-b border-[#a1bdd914]">
                  ...
                  <div className="absolute top-4 right-4 flex gap-2">
                    <button className="bg-black/50 hover:bg-black/80 text-white px-3 py-1.5 rounded flex items-center gap-2 text-sm font-semibold transition-colors backdrop-blur-md border border-white/10 min-w-[44px] min-h-[44px]"><ImageIcon size={16}/> Capa</button>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col md:flex-row p-6 md:p-8 pt-6 gap-8 text-[#b6c2cf]">
               ...
               <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2 mb-8 ml-0 md:ml-10 mt-4 md:mt-0">
                     <button className="bg-[#a1bdd914] hover:bg-[#a1bdd929] px-3 py-1.5 rounded text-sm font-bold flex items-center gap-2 text-[#c7d1db] transition-colors min-w-[44px] min-h-[44px]"><Plus size={14}/> Adicionar</button>
                     <button className="bg-[#a1bdd914] hover:bg-[#a1bdd929] px-3 py-1.5 rounded text-sm font-bold flex items-center gap-2 text-[#c7d1db] transition-colors min-w-[44px] min-h-[44px]"><Tag size={14}/> Etiquetas</button>
                     <button className="bg-[#a1bdd914] hover:bg-[#a1bdd929] px-3 py-1.5 rounded text-sm font-bold flex items-center gap-2 text-[#c7d1db] transition-colors min-w-[44px] min-h-[44px]"><Clock size={14}/> Datas</button>
                     <button className="bg-[#a1bdd914] hover:bg-[#a1bdd929] px-3 py-1.5 rounded text-sm font-bold flex items-center gap-2 text-[#c7d1db] transition-colors min-w-[44px] min-h-[44px]"><CheckSquare size={14}/> Checklist</button>
                  ...
                  <div className="flex items-start gap-4 mb-8">
                     ...
                     <div className="flex-1">
                        <div className="flex items-center justify-between mb-4">
                           ...
                           <button className="bg-[#a1bdd914] hover:bg-[#a1bdd929] px-3 py-1.5 rounded text-sm font-bold text-[#c7d1db] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center">Editar</button>
                        </div>
                        ...
                        <div className="mt-2 mb-6 text-[#c7d1db] space-y-4 text-[15px]">
                           ...
                           <button className="w-full py-2 bg-[#a1bdd914] hover:bg-[#a1bdd929] rounded text-sm text-[#8c9bab] font-semibold transition-colors flex justify-center items-center gap-2 mt-2 min-w-[44px] min-h-[44px]"> Mostrar mais</button>
                        </div>
                     </div>
                  </div>
                             ...
                             <div key={idx} className="flex gap-4 p-2 hover:bg-[#a1bdd914] rounded-lg transition-colors group relative cursor-pointer">
                                 ...
                                 <div className="flex-1 py-1 flex flex-col justify-center">
                                    <p className="font-bold text-[15px] text-[#c7d1db] mb-1 leading-tight flex justify-between items-start">
                                       ...
                                       <button className="text-[#8c9bab] hover:text-[#c7d1db] p-1 bg-[#a1bdd914] hover:bg-[#a1bdd929] rounded shrink-0 transition-colors hidden group-hover:block min-w-[44px] min-h-[44px] flex items-center justify-center"><MoreHorizontal size={16}/></button>
                                    </p>
                                    ...
                                    <div className="flex gap-2 text-[13px] font-semibold text-[#8c9bab] underline">
                                       <button className="hover:text-[#c7d1db] transition-colors text-left flex items-center gap-1 min-w-[44px] min-h-[44px]"><MessageSquare size={12} className="no-underline text-transparent"/>Comentar</button>
                                       <span>•</span>
                                       <button className="hover:text-[#c7d1db] transition-colors text-left min-w-[44px] min-h-[44px] flex items-center justify-center" onClick={(e) => {
                                          e.stopPropagation();
                                       ...
                                       <span>•</span>
                                       <button className="hover:text-[#c7d1db] transition-colors text-left min-w-[44px] min-h-[44px] flex items-center justify-center">Editar</button>
                                    </div>
                                 </div>
                             </div>
                           ))}
               ...
               <div className="w-full md:w-[360px] shrink-0 border-t md:border-t-0 md:border-l border-[#a1bdd914] pt-6 md:pt-0 md:pl-8 flex flex-col">
                  <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#a1bdd914]">
                     ...
                     <button className="text-[13px] font-semibold text-[#c7d1db] bg-[#a1bdd914] hover:bg-[#a1bdd929] px-3 py-1.5 rounded transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center">Mostrar Detalhes</button>
                  </div>
                     ...
                     <div className="flex gap-3">
                         ...
                         <div className="flex-1">
                            ...
                            <div className="flex gap-2 text-[13px] font-semibold text-[#8c9bab] underline mt-1.5 ml-1">
                               ...
                               <button className="hover:text-[#c7d1db] transition-colors text-left mt-1 min-w-[44px] min-h-[44px] flex items-center justify-center">Responder</button>
                               <span className="no-underline text-[#8c9bab]/50 mx-1 mt-1">•</span>
                               <button className="hover:text-[#c7d1db] transition-colors text-left mt-1 min-w-[44px] min-h-[44px] flex items-center justify-center">Excluir</button>
                            </div>
                         </div>
                     </div>
