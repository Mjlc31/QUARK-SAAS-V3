...
export const LoginScreen = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#050b14] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-3xl border border-white/10 relative z-10 shadow-2xl animate-enter">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-4 rounded-xl bg-lime-500 hover:bg-lime-400 text-black font-bold text-lg transition-all shadow-lg shadow-lime-500/20 flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed min-w-[44px] min-h-[44px]"
          >
