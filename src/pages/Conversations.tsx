...
const Conversations: React.FC = () => {
    ...
    return (
        <div className="h-[calc(100vh-80px)] bg-[#050b14] border border-white/5 rounded-2xl overflow-hidden flex shadow-2xl relative animate-enter mx-auto">
            ...
            <div className="w-full md:w-80 flex flex-col border-r border-white/5 bg-[#0a0f16] shrink-0">
                {/* Account Header */}
            ...
            <div className={`
                flex-1 flex flex-col bg-[#050b14] min-w-0 transition-transform duration-300 ease-in-out
                absolute inset-0 z-50 md:relative md:inset-auto md:z-auto md:translate-x-0
                    ...
                    <>
                        ...
                        <div className="h-14 md:h-16 px-3 md:px-5 border-b border-white/5 flex items-center justify-between bg-zinc-900/40 backdrop-blur-md z-20 shrink-0">
                            <div className="flex items-center gap-2 md:gap-3">
                                {/* Mobile back button */}
                                <button onClick={handleBackToList} className="md:hidden p-1.5 text-slate-400 hover:text-white rounded-lg min-w-[44px] min-h-[44px] flex items-center justify-center">
                                    <ArrowLeft size={20} />
                                </button>
                    ...
                    ">
                        ...
                        <div className="px-5 py-5 space-y-3 mt-auto mb-2">
                            <button
                                ...
                                disabled={aiLoading}
                                className="w-full text-left px-3 py-3 bg-lime-500/10 hover:bg-lime-500/20 border border-lime-500/20 text-lime-400 rounded-xl text-xs font-bold transition-colors flex items-center justify-center gap-2 relative overflow-hidden group min-w-[44px] min-h-[44px]"
                            >
                            ...
                            <button
                                className="w-full py-3 bg-zinc-800/50 hover:bg-zinc-700/50 text-slate-300 border border-white/5 rounded-xl text-xs font-medium transition-all flex items-center justify-center gap-2 group min-w-[44px] min-h-[44px]"
